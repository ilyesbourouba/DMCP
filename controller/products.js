...
exports.updateProduct = async(req, res) => {
    const { id, name_fr, name_ar, name_en, desc_fr, desc_ar, desc_en, category, price, stock, best_selling, new_product, top_rating, prefs } = req.body;
    ...
    const result = await ProductModel.updateProduct(id, name_fr, name_ar, name_en, desc_fr, desc_ar, desc_en, category, price, stock, best_selling, new_product, top_rating, image_names, prefs);
